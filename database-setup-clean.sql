-- =====================================================
-- PREMA'S SHOP - CLEAN DATABASE SETUP
...
DROP POLICY IF EXISTS "Admins and delivery partners can view orders" ON public.orders;
DROP POLICY IF EXISTS "Admins can manage orders" ON public.orders;
DROP POLICY IF EXISTS "Users can view own order items" ON public.order_items;
DROP POLICY IF EXISTS "Admins can view all order items" ON public.order_items;
DROP POLICY IF EXISTS "Delivery partners can view own profile" ON public.delivery_partners;
DROP POLICY IF EXISTS "Anyone can apply as delivery partner" ON public.delivery_partners;
...
-- Add update triggers (drop first to avoid conflicts)
...
-- =====================================================
-- 7. INSERT SAMPLE DATA (ONLY IF EMPTY)
-- =====================================================

-- Check if products already exist, if not insert sample data
DO $$
BEGIN
...
-- Check if settings already exist, if not insert sample data
DO $$
BEGIN
